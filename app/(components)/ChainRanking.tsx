...
function ChainRanking({ chains, nickname }: ChainRankingProps) {
    return (
        <div className="w-full max-w-[28rem] relative h-auto px-4 py-4 md:px-6 md:py-6 rounded-3xl text-white"
            style={{
